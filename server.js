...
app.get('/proxy', (req, res) => {
    ...
    const fn = async () => {
      ...
      const url3 = document2.querySelectorAll("a")[8].href;

      options.headers.Referer = url3;  options.method = "GET";
      ...
      // options.remve('body');
      const fin_promise = await fetch(url3, {
        method : 'GET',
        headers : Headers,
      });
      ...
      console.log(document3.querySelectorAll("td")[18].innerHTML);
